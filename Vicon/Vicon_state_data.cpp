...
#define JUMP_THRESHOLD 0.5//maximum jump between velocities
#define POS_JUMP_THRES 150
#define JUMP_THRESHOLD_ATTITUDE 4 //maximum jump between attitudes in degree for every step
...
double dx_in_mm, dy_in_mm, dz_in_mm;
      ...
      for( unsigned int SubjectIndex = 0 ; SubjectIndex < SubjectCount ; ++SubjectIndex )
      {
        ...
        for( unsigned int SegmentIndex = 0 ; SegmentIndex < SegmentCount ; ++SegmentIndex )
        {
          ...
          //                                                    << Adapt( _Output_GetSegmentGlobalRotationEulerXYZ.Occluded ) << std::endl;
            ...
            vicon_msg.position[0] = _Output_GetSegmentGlobalTranslation.Translation[ 0 ];
            vicon_msg.position[1] = _Output_GetSegmentGlobalTranslation.Translation[ 1 ];
            vicon_msg.position[2] = _Output_GetSegmentGlobalTranslation.Translation[ 2 ];


            vicon_msg.attitude[0] = _Output_GetSegmentGlobalRotationEulerXYZ.Rotation[ 0 ];
            vicon_msg.attitude[1] = _Output_GetSegmentGlobalRotationEulerXYZ.Rotation[ 1 ];
            vicon_msg.attitude[2] = _Output_GetSegmentGlobalRotationEulerXYZ.Rotation[ 2 ];
            ...
            lcm.publish(SegmentName, &vicon_msg);
